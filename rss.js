...
const url = "https://blog.grizzley.ch/";
...
//console.log(feedUrl);
const feedPageUrl = proxyUrl + feedUrl;
//console.log(feedPageUrl);
const xmlTxt = request(feedPageUrl); 
